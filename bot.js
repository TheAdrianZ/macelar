...
client.on('message', message => {
  ...
  **__[❖═════════════════════════════❖]__**
        َ   __💀Macelar's Family💀 Bot [by Huawei_fak boty de descord#6969]__
...
client.on('message', message => {
  ...
  message.author.sendMessage(`**:gear: __Invite Link__ :gear:** | **https://discordapp.com/api/oauth2/authorize?client_id=594962135159668839&permissions=0&scope=bot**`);
...
client.on('message', message => {
  ...
  message.author.sendMessage(`**:gear: __Support__ :gear: [Bot make by Friday BOT] :**https://discord.gg/nB3jB4T**`);
            ...
            message.channel.send({
                embed: new Discord.RichEmbed()
                    ...
                    .addField('``My ID``' , `[ ${client.user.id} ]` , true)
                          ...
                          .setFooter('**Macelar's Family Bot © 2019 | All Rights Reserved by Huawei_fak boty de descord#6969 **')
            })
        }
        });
