...
client.on('message', message => {
  ...
  **__Macelar's Family Bot__**`);
                        ...
                        client.on('guildCreate', guild => {
                            client.channels.get("595088713692872715").send(`**Macelar's Family Joined A New Server✅ 
                            ...
                            client.on('guildDelete', guild => {
                              client.channels.get("595088713692872715").send(`**Macelar's Family Left A Server ❎ 
                            Server name: __${guild.name}__
                            Server owner: __${guild.owner}__
                            Server id: __${guild.id}__ 
                            Server Count: __${guild.memberCount}__**`)
            ...
            message.channel.send({
                embed: new Discord.RichEmbed()
                    ...
                    .addField('``My ID``' , `[ ${client.user.id} ]` , true)
                          ...
                          .setFooter('** Tornado Rewards © 2019 | All Rights Reserved **')
            })
        }
        });
